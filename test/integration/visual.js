...
describe('👀 page screenshots are correct', function() {
  ...
  describe('wide screen', function() {
    ...
    it('/web-bluetooth', async function() {
      return takeAndCompareScreenshot(page, 'web-bluetooth', 'wide');
    });
    it('/web-usb', async function() {
      return takeAndCompareScreenshot(page, 'web-usb', 'wide');
    });
    it('/web-nfc', async function() {
      return takeAndCompareScreenshot(page, 'web-nfc', 'wide');
    });
  ...
  describe('narrow screen', function() {
    ...
    it('/web-bluetooth', async function() {
      return takeAndCompareScreenshot(page, 'web-bluetooth', 'narrow');
    });
    it('/web-usb', async function() {
      return takeAndCompareScreenshot(page, 'web-usb', 'narrow');
    });
    it('/web-nfc', async function() {
      return takeAndCompareScreenshot(page, 'web-nfc', 'narrow');
    });
    it('/404', async function() {
