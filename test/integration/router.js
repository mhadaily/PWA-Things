...
describe('routing tests', function() {
  ...
  it('the page selector switches pages', async function() {
    ...
    await testNavigation(page, 'web-usb', 'WebUSB');
    await testNavigation(page, 'web-bluetooth', 'WebBluetooth');
    await testNavigation(page, 'web-nfc', 'WebNFC');
  });
  ...
  it('the page selector switches pages in a different way', async function() {
    ...
    await testNavigationInADifferentWay(page, 'web-nfc', 'WebNFC');
    await testNavigationInADifferentWay(page, 'web-bleutooth', 'WebBluetooth');
    await testNavigationInADifferentWay(page, 'web-usb', 'WebUSB');
  });
});
